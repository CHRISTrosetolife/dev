...
export function app_learn_math_multiplication_choices(root) {
  ...
  app_learn_math_multiplication_choices_generic(root, operation_word, filter, symbol_get, operation);
}
function app_learn_math_multiplication_choices_generic(root, operation_word, filter, symbol_get, operation) {
