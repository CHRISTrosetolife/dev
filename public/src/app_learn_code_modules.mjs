...
export function app_learn_code_modules() {
    let module_intro = [];
    list_add(module_intro, lesson_console_log);
    list_add(module_intro, lesson_log_number);
    list_add(module_intro, lesson_add);
    list_add(module_intro, lesson_subtract);
    list_add(module_intro, lesson_multiply);
    list_add(module_intro, lesson_divide);
    list_add(module_intro, lesson_less_than);
    list_add(module_intro, lesson_greater_than);
    list_add(module_intro, lesson_equal_number);
    list_add(module_intro, lesson_equal_string);
    list_add(module_intro, lesson_less_than_equal);
    list_add(module_intro, lesson_greater_than_equal);
    list_add(module_intro, lesson_equal_not_number);
    ...
    list_add(module_intro, lesson_if_binary);
    list_add(module_intro, lesson_if_variable);
    list_add(module_intro, lesson_if_else);
    list_add(module_intro, lesson_if_else_zero);
    list_add(module_intro, lesson_if_else_positive);
    list_add(module_intro, lesson_if_else_negative);
    list_add(module_intro, lesson_if_else_if);
    list_add(module_intro, lesson_mod);
    list_add(module_intro, lesson_mod_even);
    list_add(module_intro, lesson_if_else_nested_if);
    return module_intro;
}
