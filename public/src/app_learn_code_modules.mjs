...
export function app_learn_code_modules() {
    let module_1 = [];
    list_add(module_1, lesson_console_log);
    list_add(module_1, lesson_log_number);
    list_add(module_1, lesson_add);
    list_add(module_1, lesson_subtract);
    list_add(module_1, lesson_multiply);
    list_add(module_1, lesson_divide);
    list_add(module_1, lesson_less_than);
    list_add(module_1, lesson_greater_than);
    list_add(module_1, lesson_equal_number);
    list_add(module_1, lesson_equal_string);
    list_add(module_1, lesson_less_than_equal);
    list_add(module_1, lesson_greater_than_equal);
    list_add(module_1, lesson_equal_not_number);
    list_add(module_1, lesson_equal_not_string);
    list_add(module_1, lesson_statements_two);
    list_add(module_1, lesson_statements_three);
    list_add(module_1, lesson_log_boolean);
    list_add(module_1, lesson_variable);
    list_add(module_1, lesson_variable_log_twice);
    list_add(module_1, lesson_variable_change);
    list_add(module_1, lesson_variable_shorthand);
    list_add(module_1, lesson_variable_change_2);
    list_add(module_1, lesson_variables_two);
    list_add(module_1, lesson_variables_declare_shorthand);
    list_add(module_1, lesson_add_numbers_three);
    list_add(module_1, lesson_variables_three);
    list_add(module_1, lesson_variable_binary);
    list_add(module_1, lesson_if_true);
    list_add(module_1, lesson_if_false);
    list_add(module_1, lesson_if_binary);
    list_add(module_1, lesson_if_variable);
    list_add(module_1, lesson_if_else);
    list_add(module_1, lesson_if_else_zero);
    list_add(module_1, lesson_if_else_positive);
    list_add(module_1, lesson_if_else_negative);
    list_add(module_1, lesson_if_else_if);
    list_add(module_1, lesson_mod);
    list_add(module_1, lesson_mod_even);
    list_add(module_1, lesson_if_else_nested_if);
    return module_1;
}
