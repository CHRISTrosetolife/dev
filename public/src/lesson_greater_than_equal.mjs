...
export function lesson_greater_than_equal() {
  ...
  const example_message =
    "outputting whether or not a number is greater than or equal to another number";
  ...
  function screen_before1(parent) {
    html_p_text(
      parent,
      'as "less than or equal to" ( ≤ ) was for "less than" ( < ) so "greater than or equal to" ( ≥ ) is for "greater than" ( > )',
    );
