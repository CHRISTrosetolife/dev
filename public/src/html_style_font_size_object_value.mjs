...
export function html_style_font_size_object_value(default_font_size) {
    const v = html_style_default_font_size_value_get(default_font_size);
  return html_style_font_size_object(v);
}
function html_style_font_size_object(v) {
    return {
        [html_style_font_size_property()]: v,
    };
}
