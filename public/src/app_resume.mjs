...
export function app_resume() {
  ...
  html_cycle_p(
    ...
    "app` to record audio `verse by verse`, `convert to mp3` to save space and `uploads to Firebase`; `downloads` audio files from Firebase; `generates` a video of a bible chapter",
  );
