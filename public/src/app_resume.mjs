...
export function app_resume() {
  ...
  html_cycle_p(
    root,
    [noop],
    "User is presented with JavaScript programming concepts; for each concept: user chooses correct output given source code; user chooses correct source code given an output",
  );
