...
export function app_resume() {
  ...
  html_p_text(
    root,
    "~2016 - ~2018: Senior Software Engineer; Created warehouse software. Used C#/.NET, React, Knockout, EntityFramework, MySQL",
  );
  app_resume_header_3(
    root,
  ...
  html_p_text(
    root,
    "~2009 - ~2016: From Intern to Team Lead, Senior Software Engineer; Created debt collections software. Used C#/.NET, AngularJS, EntityFramework, T-SQL and IIS",
  );
