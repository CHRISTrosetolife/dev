export function app_gs_bible_chapter_jas01() {
  return [
    ...
    {
      verse_number: "4",
      text: "Allow perseverance to finish its work, so that you may be mature and complete, not lacking anything.",
      objections: [],
      sermons: [],
      questions: [],
    },
    {
      ...
      sermons: [
        {
          sermon:
            "God gives gifts generously to sinners`if we lack wisdom, let us ask God for wisdom`if we ask God for wisdom, then God will give us wisdom`we must ask God for wisdom in faith`let us not doubt when we ask God for wisdom`those who doubt are like when the wind blows and tosses a wave in the ocean`those who doubt should not expect God to answer their prayer`those who doubt are double-minded`those who doubt are unstable in all their ways",
          count: 4,
        },
      ],
      questions: [],
    ...
    {
      verse_number: "6",
      text: "But he must ask in faith, without doubting, because he who doubts is like a wave of the sea, blown and tossed by the wind.",
      objections: [],
      sermons: [],
      questions: [],
    },
    {
      verse_number: "7",
      text: "That man should not expect to receive anything from the Lord.",
      objections: [],
      sermons: [],
      questions: [],
    },
    ...
    {
      verse_number: "11",
      text: "For the sun rises with scorching heat and withers the plant; its flower falls and its beauty is lost. So too, the rich man will fade away in the midst of his pursuits.",
      objections: [],
      sermons: [],
      questions: [],
    },
    {
      ...
      objections: [
        {
          text: "Life is one difficulty after another. What is the point of it all? We go through so much difficulty and then we get nothing afterwards?",
          count: 1,
        },
      ],
      sermons: [
    ...
    },
    {
      ...
      objections: [
        {
          text: "Everything is God's fault. God makes me do evil.",
          count: 1,
        },
      ],
      sermons: [
    ...
    },
    {
      ...
      objections: [
        {
          text: "There is no good and evil. If I do something you consider evil, and no one finds out, then nothing bad will ever happen to me.",
          count: 1,
        },
      ],
      sermons: [],
    ...
    },
    {
      ...
      sermons: [
        {
          sermon:
            "God is the Father of the heavenly lights`there is no change with the Father`there are no shadows that shift from light moving with God the Father`Good and perfect gifts come from God, whose throne is in heaven above`God speaks the word of truth`through the word truth God gives us spiritual birth`when we are spiritually born, God makes us a kind of the firstfruits of the creation of God",
          count: 2,
        },
      ],
      questions: [
    ...
    },
    {
      ...
      questions: [
        ...
        {
          text: "Is it okay for people to constantly interrupt and talk over one another?",
          count: 1,
        },
      ],
    },
    {
      verse_number: "20",
      text: "for man’s anger does not bring about the righteousness that God desires.",
      objections: [],
      sermons: [],
      questions: [],
    },
    ...
    {
      verse_number: "24",
      text: "and after observing himself goes away and immediately forgets what he looks like.",
      objections: [],
      sermons: [],
      questions: [],
    },
    ...
    },
    {
      ...
      objections: [
        {
          text: "All that matters is our actions, not our words or even beliefs. With my actions, I am generous to the poor. It does not matter what I say. Words have no power. I am already religious in my actions without Jesus.",
          count: 1,
        },
      ],
      sermons: [
    ...
    },
    {
      ...
      objections: [
        {
          text: "Morality is not harming people. As long as I do not do things like murder or steal, I am a good person. What you call sexual sin does not matter. What I do in my bedroom with a consenting adult hurts no one.",
          count: 1,
        },
      ],
      sermons: [],
