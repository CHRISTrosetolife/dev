export function app_gs_bible_chapter_jas01() {
  return [
    ...
    },
    {
      ...
      objections: [
        {
          text: "All that matters is our actions, not our words or beliefs. With my actions, I am generous to the poor. It does not matter what I say or believe. I am already religious without Jesus.",
          count: 1,
        },
      ],
      sermons: [
