...
export function app_demo_2024_05_19() {
  ...
  let screens = [
    (parent) => {
      ...
      html_cycle_code_multiple(parent, ["this speeds up development"]);
    },
    (parent) => {
      html_cycle_code_multiple(parent, [
      ...
      html_cycle_code_multiple(parent, ["... and view the change in github :"]);
    ...
    (parent) => {
      html_cycle_code_multiple(parent, ["if we add a function body ..."]);
      html_img_limited_centered(parent, "demo\\2024_05_19\\11.png");
      html_cycle_code_multiple(parent, ["... and run `function_auto` ..."]);
    ...
    (parent) => {
      ...
      html_cycle_code_multiple(parent, ["... and it works !"]);
