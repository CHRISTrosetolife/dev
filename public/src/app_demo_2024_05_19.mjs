...
export function app_demo_2024_05_19() {
  ...
  let screens = [
    (parent) => {
      ...
      html_cycle_monospace_multiple(parent, ["this speeds up development"]);
    },
    (parent) => {
      html_cycle_monospace_multiple(parent, [
    ...
    (parent) => {
      html_cycle_monospace_multiple(parent, ["if we add a function body ..."]);
    ...
    (parent) => {
      ...
      html_cycle_monospace_multiple(parent, ["... and it works !"]);
