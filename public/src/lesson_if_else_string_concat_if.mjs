...
export function lesson_if_else_string_concat_if() {
    ...
    return lesson_simple(function () {
        ...
        let lines = [app_learn_code_log(n), js_code_statement_let_assign('before', string_delimit('')), `if (${n} >= 0) {`, js_code_statement_assign('before', string_delimit('not ')), `}`, app_learn_code_log_join_plus(['before', string_delimit('negative')])];
