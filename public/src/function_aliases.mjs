...
export function function_aliases() {
    ...
    function_aliases_register(all, fn_name("function_cache_refresh_args_command_line"), ["fca"]);
    ...
    function_aliases_register(all, fn_name("function_param_delete_index"), ["pdi"]);
    function_aliases_register(all, fn_name("function_param_delete_name"), ["pd"]);
    function_aliases_register(all, fn_name("function_param_move_first_index"), ["pfi"]);
    function_aliases_register(all, fn_name("function_param_move_first_name"), ["pf"]);
    ...
    function_aliases_register(all, fn_name("function_param_new_doubled"), ["pdb"]);
    ...
    function_aliases_register(all, fn_name("app_contact_download_unhandled"), ["cd"]);
    ...
    function_aliases_register(all, fn_name("app_contact_download_single"), ["cds"]);
    function_aliases_register(all, fn_name("app_contact_download_responses_generate"), ["cdg"]);
    function_aliases_register(all, fn_name("app_contact_download_responses_test"), ["cdt"]);
    function_aliases_register(all, fn_name('app_contact_download_responses_overwrite'), ["cdo"]);
    marker();
    return all;
}
