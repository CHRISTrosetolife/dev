...
export function prayers() {
  let v = list_denest([
    ...
    "Cause me to fulfill my ministry and suffer in the flesh and cease from sin",
    "If it means not sinning, take anything away, do anything",
    "Thank You",
    "Cause me to never be hospitalized again, never be in therapy again and to rather live on earth than die",
    ...
    prayers_family(),
    "May love have no pain during period",
    "May love feel and be strong during period",
    "May love have no pain during childbirth",
    "May love feel and be strong during childbirth",
