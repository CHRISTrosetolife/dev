...
export function prayers() {
  let v = list_denest([
    ...
    "Cause all Christians including love and I to love, be holy, perfect in mercy, to eagerly and joyfully do the desire of God, to be humble, to be gentle, to be patient, to hope, to be diligent, to be wise, to faithful in marriage if married, be generous, to obey Scripture, to pray perfectly, to choose good, including not vowing",
