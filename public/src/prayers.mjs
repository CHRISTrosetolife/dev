...
export function prayers() {
  let v = list_denest([
    ...
    prayers_family(),
    "Let love have no pain during period",
    "Let love feel and be strong during period",
    "Let love have no pain during childbirth",
    "Let love feel and be strong during childbirth",
